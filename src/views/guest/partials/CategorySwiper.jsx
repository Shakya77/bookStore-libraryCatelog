    ...
    return (
        <section className="">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Genres</h3>
                    <p className="text-gray-600">Browse Our Extensive Collection of Books Across Different Genres.</p>
                </div>
